...
const FactorySlider = () => {
    ...
    const projects = [
        {
            id: 1,
            category: "OIL & Gas World",
            title: "Industrial Economy",
            description: "Quis trud exercitation ullam laboris ut aliquip aute irure dolor sed.",
    ...
    const getGapSize = () => {
        if (itemsPerPage === 1) return 16;
        if (itemsPerPage === 2) return 24;
        return 32;
    };
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        ...
                        unt enim ad minim veniam quis trud exercitation ullam laboris nisiut
                    </p>
                </div>
                ...
                <div className="relative">
                    <div className="overflow-hidden">
                        <div
                            ...
                            style={{
                                transform: `translateX(calc(-${currentSlide * (100 / itemsPerPage)}% - ${currentSlide * getGapSize()}px))`,
                                gap: `${getGapSize()}px`
                            }}
                        >
                            {projects.map((item) => (
                    ...
                    <div className="flex items-center justify-center gap-3 mt-12">
                        {Array.from({ length: maxSlide + 1 }).map((_, index) => (
                            <button
                                ...
                                className={`h-2 transition-all duration-300 ${currentSlide === index
                                    ? 'w-8 bg-gray-900'
