        ...
        <section className="py-20 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            <Image
                                ...
                                width={350}
                                height={500}
                                className="object-cover w-[350px] h-[500px]"
                            />
                        </motion.div>
                        ...
                        <div className="absolute -bottom-10 left-0 bg-white rounded-lg shadow-md px-5 py-3 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 leading-tight">Chain Of Factories</p>
                            </div>
                        </div>
                    </motion.div>
                ...
                <motion.div initial={{ opacity: 0, x: 80 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
                    <p className="text-orange-500 font-semibold uppercase tracking-wide mb-2">Erdunt Is The Industry Leaders</p>
                    <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-4">
                        Join The New Innovation <br />
                    ...
                    <ul className="space-y-6">
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="font-bold text-lg text-gray-900">Petroleum Industry</h4>
                                <p className="text-gray-600 text-sm">
                                    Incididunt ut labore et dolore magna aliqua dnim veniam, quis nos trud exercitation dolor ullamco
                        ...
                        <li className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="font-bold text-lg text-gray-900">Worldwide Manufacturing</h4>
                                <p className="text-gray-600 text-sm">
                                    Incididunt ut labore et dolore magna aliqua dnim veniam, quis nos trud exercitation dolor ullamco
                                    laboris nisi ut aliquip.
                                </p>
